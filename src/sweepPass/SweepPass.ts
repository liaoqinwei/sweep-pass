...
export default class SweepPass extends Pass {
  ...
  render(renderer: WebGLRenderer, writeBuffer: WebGLRenderTarget, readBuffer: WebGLRenderTarget, deltaTime: number, maskActive: boolean): void {
    ...
    console.log(new THREE.Vector4(0,0,-1,1).applyMatrix4(this.camera.matrixWorld.clone().multiply(this.camera.projectionMatrixInverse.clone())).divideScalar(new THREE.Vector4(1,0,0,1).applyMatrix4(this.camera.matrixWorld.clone().multiply(this.camera.projectionMatrixInverse.clone())).w))
